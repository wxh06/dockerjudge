...
class TestNode(unittest.TestCase):
    def test_nodejs(self):
        result = judge(
            Node(12), b'console.log("Hello World")', [(b"", b"Hello World")]
        )
        self.assertEqual(result[0][0][0], Status.AC)
...
class TestShell(unittest.TestCase):
    def test_bash(self):
        result = judge(
            Bash(), b"echo Hello, world!", [(b"", b"Hello, world!")]
        )
        self.assertEqual(result[0][0][0], Status.AC)
...
class TestPHP(unittest.TestCase):
    def test_php(self):
        result = judge(
            PHP(), b'<?php echo "Hello, world!";', [(b"", b"Hello, world!")]
        )
        self.assertEqual(result[0][0][0], Status.AC)
...
class TestRuby(unittest.TestCase):
    def test_ruby(self):
        result = judge(
            Ruby(), b'print "Hello, world!";', [(b"", b"Hello, world!")]
        )
        self.assertEqual(result[0][0][0], Status.AC)
...
class TestSwift(unittest.TestCase):
    def test_swiftc(self):
        result = judge(
            Swift(), b'print("Hello, world!")', [(b"", b"Hello, world!")]
        )
        self.assertEqual(result[0][0][0], Status.AC)
